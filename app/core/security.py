"""
Security utilities: password hashing (bcrypt), JWT creation/validation, token generation.
"""
import hashlib
import secrets
...
def decode_access_token(token: str) -> dict[str, Any]:
    """Decode and validate a JWT access token. Raises jose.JWTError on failure."""
    payload = jwt.decode(
        token,
        settings.jwt_secret,
